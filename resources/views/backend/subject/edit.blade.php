                                        ...
                                        <div class="panel panel-inverse">
                                            ...
                                            <div class="shadow-sm">
                                                <div class="container">
                                                    ...
                                                    <!-- start form -->
                                                    <form name="studentForm" id="studentForm" method="POST" action="{{ route('subject.update',$subject[0]->id) }}" data-parsley-validate="true" enctype="multipart/form-data">
